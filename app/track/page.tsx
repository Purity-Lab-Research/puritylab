  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-10">
        <Link
          href="/account"
          className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-[#1A2B4A] transition-colors mb-6"
        >
        ...
        >
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:border-[#0097A7] focus:ring-2 focus:ring-[#0097A7]/20 outline-none transition font-[family-name:var(--font-body)]"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg bg-[#1A2B4A] px-6 py-3 text-sm font-semibold text-white hover:bg-[#0097A7] transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-[family-name:var(--font-body)]"
          >
                    ...
                    <div>
                      ...
                      <p className="text-gray-500">
                        ...
                        {item.purchase_type === "subscription" && (
                          <span className="ml-2 text-xs text-[#0097A7]">
                            (Subscription)
                          </span>
                        )}
                      </p>
