  ...
  if (success) {
    return (
      <div className="text-center py-4">
        <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-[#0d9488]/10">
          <svg className="h-8 w-8 text-[#0d9488]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        ...
        <p className="text-gray-600 text-sm leading-relaxed mb-6">
          ...
          <span className="font-semibold text-[#0f766e]">{email}</span>.
          <br />
        ...
        <Link
          href="/login"
          className="inline-block mt-5 text-sm text-[#0d9488] hover:underline font-medium"
        >
          Go to Sign In
        </Link>
      </div>
