...
export default function RegisterPage() {
  ...
  if (success) {
    return (
      <div className="text-center py-4">
        ...
        <div className="rounded-lg bg-primary/5 border border-blue-100 p-4 text-xs text-gray-500 leading-relaxed">
  ...
  return (
    <>
      <h1 className="text-2xl font-extrabold text-[#111111] text-center mb-6">
        Create Account
      </h1>
