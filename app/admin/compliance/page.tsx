...
export const metadata: Metadata = {
  title: "Compliance | Purity Lab Admin",
};
...
function Checkbox({ children }: { children: React.ReactNode }) {
  return (
    <label className="flex items-start gap-3 py-1.5 cursor-pointer select-none">
      <input
        type="checkbox"
        className="mt-0.5 h-4 w-4 rounded border-gray-300 text-[#10B981] focus:ring-[#10B981] shrink-0"
        readOnly
      />
      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
            <h3 className="mb-2 text-sm font-bold uppercase tracking-wide text-[#10B981]">
              Access
            </h3>
