...
const SELECT_CLS =
  "w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-[#0d9488] focus:outline-none focus:ring-1 focus:ring-[#0d9488] transition-colors";
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        {!showForm && (
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-[#0f766e] px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#0f766e]/90"
          >
