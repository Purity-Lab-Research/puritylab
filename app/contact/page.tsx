    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          {/* LEFT  -  Contact Info */}
          <div>
            <h2 className="text-xl font-bold text-[#111111] font-[family-name:var(--font-heading)]">
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#111111]/10">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-sm text-[#10B981] hover:underline font-[family-name:var(--font-body)]"
                  >
                    {CONTACT_EMAIL}
                  </a>
                </div>
            ...
            {/* Wholesale */}
            <div className="mt-10 rounded-xl border border-[#dde2ea] bg-[#111111]/5 p-6">
              <div className="flex items-center gap-3">
                <Package className="h-5 w-5 text-[#111111]" />
                <h3 className="text-sm font-bold text-[#111111] font-[family-name:var(--font-heading)]">
          ...
          <div className="rounded-xl border border-[#dde2ea] bg-white p-6 shadow-sm lg:p-8">
            <h2 className="mb-6 text-xl font-bold text-[#111111] font-[family-name:var(--font-heading)]">
