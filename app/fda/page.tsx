...
const sections = [
  ...
  },
  {
    ...
    content:
      "Under no circumstances should any product purchased from Purity Lab be ingested, injected, inhaled, or applied to the body. These products are chemical reagents for laboratory research only. Any misuse of these products is the sole responsibility of the purchaser.",
  },
  {
    icon: UserCheck,
    key: "fda_section_5",
