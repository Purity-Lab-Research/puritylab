        ...
        <div className="prose prose-sm prose-gray max-w-none space-y-8 text-gray-700 font-[family-name:var(--font-body)]">
          ...
          <div>
            ...
            <div className="mt-2 text-sm leading-relaxed pl-5">
              ...
              <p>Email:{" "}
                <a href={`mailto:${PRIVACY_EMAIL}`} className="text-[#0d9488] hover:underline">
                  {PRIVACY_EMAIL}
                </a>
              </p>
            </div>
          ...
          <div>
            ...
            <h3 className="mt-4 text-base font-semibold text-[#0f766e] font-[family-name:var(--font-heading)]">
          ...
          <div className="rounded-xl border border-[#dde2ea] bg-[#0f766e]/5 p-6">
            <p className="text-sm leading-relaxed">
              <strong className="text-[#0f766e]">Questions?</strong> Contact our Privacy Officer at{" "}
              <a href={`mailto:${PRIVACY_EMAIL}`} className="text-[#0d9488] hover:underline">
                {PRIVACY_EMAIL}
              </a>
            </p>
