          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                value={form.country}
                onChange={handleChange}
                className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:border-[#0d9488] focus:ring-1 focus:ring-[#0d9488] outline-none transition-colors bg-white"
              >
                {COUNTRIES.map((c) => (
      ...
      {addresses.length > 0 ? (
        <div className="grid sm:grid-cols-2 gap-4">
          {addresses.map((addr) => (
            ...
            >
              {addr.is_default && (
                <span className="absolute top-4 right-4 inline-flex items-center gap-1 text-xs font-medium text-[#0f766e] bg-blue-50 px-2 py-0.5 rounded-full">
              ...
              <div className="flex gap-2 mt-4">
                <button
                  ...
                  className="inline-flex items-center gap-1 text-xs text-gray-500 hover:text-[#0d9488] transition-colors"
                >
