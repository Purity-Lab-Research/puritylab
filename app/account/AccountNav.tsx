      ...
      {links.map((link) => (
        <Link
          ...
          className={`whitespace-nowrap rounded-lg px-3 py-2 text-sm transition-all duration-200 ${
            isActive(link.href)
              ? "bg-[#0f766e] text-white font-semibold border-l-[3px] border-white/40"
              : "text-gray-700 border-l-[3px] border-transparent hover:border-[#0f766e] hover:bg-[#0f766e]/5 hover:text-[#0f766e] hover:translate-x-1 hover:shadow-sm"
          }`}
        >
          {link.label}
        </Link>
