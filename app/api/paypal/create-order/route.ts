  ...
  try {
    ...
    const paypalOrder = {
      ...
      payment_source: {
        paypal: {
          experience_context: {
            brand_name: "Purity Lab",
            shipping_preference: "SET_PROVIDED_ADDRESS",
            user_action: "PAY_NOW",
            return_url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://puritylabresearch.com"}/checkout/success?orderId=${order.id}`,
            cancel_url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://puritylabresearch.com"}/checkout`,
          },
        },
      },
    };
