...
function unsubscribeFooter(email: string): string {
  ...
  return `<p style="margin:8px 0 0;font-size:11px;color:#bbb;">
    ...
    &nbsp;|&nbsp;
    <a href="mailto:support@puritylabresearch.com?subject=Unsubscribe&body=Please%20unsubscribe%20${encoded}%20from%20marketing%20emails." style="color:#999;text-decoration:underline;">Unsubscribe</a>
  </p>`;
}
