...
const CONSENT_KEY = "puritylab_cookie_consent";
          ...
          {!showDetails ? (
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-4">
              <p className="text-sm text-gray-600 leading-relaxed">
                ...
                <Link href="/policies/cookies" className="text-[#10B981] hover:underline">
                  Cookie Policy
                </Link>
              </p>
              <div className="flex items-center gap-2 shrink-0">
                <button
                  onClick={acceptAll}
                  className="rounded-lg bg-[#111111] px-5 py-2 text-sm font-semibold text-white hover:bg-[#10B981] transition-colors"
                >
                  Accept All
                </button>
                <button
                ...
                <button
                  ...
                  className="text-sm text-[#10B981] hover:underline px-2"
                >
                  Customize
                </button>
              </div>
            ...
            <div className="py-4 space-y-4">
              <p className="text-sm text-gray-600 leading-relaxed">
                ...
                <Link href="/policies/privacy" className="text-[#10B981] hover:underline">
                  Privacy Policy
                </Link>
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <label className="flex items-start gap-3 rounded-lg border border-gray-200 bg-gray-50 p-3">
                  <input type="checkbox" checked disabled className="mt-0.5 rounded border-gray-300 text-[#10B981]" />
                  <div>
