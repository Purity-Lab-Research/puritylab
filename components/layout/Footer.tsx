        ...
        <div className="grid gap-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-1">
            <div className="mb-4">
              ...
              <p className="mt-0.5 text-xs font-semibold tracking-[0.2em] text-[#0d9488] uppercase">
                Research Peptides
              </p>
            </div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                aria-label="TikTok"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/70 transition-colors hover:bg-[#0d9488] hover:text-white"
              >
                <svg
        ...
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="space-y-3 text-xs leading-relaxed text-white/40">
            ...
            <p>
              ...
              By purchasing from Purity Lab, you agree that the products will be
