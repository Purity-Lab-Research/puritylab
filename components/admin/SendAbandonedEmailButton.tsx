          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-lg max-h-[85vh] overflow-y-auto">
            ...
            <div className="px-5 pt-4 space-y-1.5 text-sm">
              <div className="flex gap-2">
                ...
                <span className="text-gray-900">Purity Lab &lt;noreply@puritylabresearch.com&gt;</span>
              </div>
              <div className="flex gap-2">
              ...
              <div className="flex gap-2">
                ...
                <span className="text-gray-900 font-medium">
                  You left something behind! Complete your Purity Lab order #{orderNumber}
                </span>
              </div>
            </div>
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden bg-[#f5f5f5]">
                ...
                <div className="bg-gray-50 border-t px-5 py-3 text-center">
                  <p className="text-[11px] text-gray-400">
                    Questions? Email us at support@puritylabresearch.com
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border-t px-5 py-4 flex gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-[#111111] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#000000] transition-colors disabled:opacity-50"
              >
                {status === "sending" ? (
