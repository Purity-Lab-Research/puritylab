...
export default function RichTextEditor({
  ...
  const editor = useEditor({
    ...
    extensions: [
      ...
      Link.configure({
        openOnClick: false,
        HTMLAttributes: { class: "text-[#0d9488] underline" },
      }),
      Underline,
  ...
  return (
    <div className="rte-editor rounded-lg border border-gray-300 focus-within:border-[#0d9488] focus-within:ring-1 focus-within:ring-[#0d9488] overflow-hidden bg-white">
