      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex gap-2">
          <textarea
            ...
            rows={2}
            className="flex-1 rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#10B981] focus:outline-none focus:ring-1 focus:ring-[#10B981] resize-none"
          />
          <button
            onClick={handleAdd}
            disabled={saving || !body.trim()}
            className="self-end rounded-lg bg-[#111111] px-3 py-2 text-sm font-semibold text-white hover:bg-[#10B981] transition-colors disabled:opacity-50"
          >
