      ...
      <div className="relative mb-5">
        <div
          ...
          style={{
            ...
            backgroundColor: hovered ? "#0d9488" : "#0f766e",
            transform: hovered ? "scale(1.1)" : "scale(1)",
          }}
        >
          <step.icon className="h-7 w-7 text-white" strokeWidth={1.75} />
        </div>
        <span className="absolute -top-1.5 -right-1.5 flex h-7 w-7 items-center justify-center rounded-full bg-[#0d9488] text-xs font-bold text-white">
          {step.number}
        </span>
      </div>
