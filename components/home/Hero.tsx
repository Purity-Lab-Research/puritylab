...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden h-[90vh] md:h-[85vh] flex items-center justify-center bg-[#E0D4F0]">
      ...
      <div ref={contentRef} className="relative z-10 text-center px-4 sm:px-6 pt-16 sm:pt-20 pb-4 sm:pb-24 max-w-3xl mx-auto">
        ...
        <p className="mt-4 sm:mt-6 text-base sm:text-lg text-[#555] max-w-lg mx-auto leading-relaxed">
          Every batch tested for purity, identity, heavy metals, sterility, and endotoxins. Full results published. Verify any product in seconds.
        </p>
