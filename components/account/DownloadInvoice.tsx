...
<head>
  ...
  <style>
    ...
    h1 { font-size: 28px; color: #0f766e; margin: 0; }
...
<body>
  <div class="header">
    <div>
      <h1>PURITY LAB</h1>
      <p style="margin:4px 0 0;font-size:12px;color:#0d9488;letter-spacing:1px;">RESEARCH PEPTIDES</p>
    </div>
  ...
  <div class="footer">
    <p>Purity Lab &middot; Windsor, Ontario, Canada &middot; support@puritylabresearch.com</p>
