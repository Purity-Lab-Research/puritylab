...
export default function ShareButtons({ url, title }: Props) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        onClick={copyLink}
        className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 text-gray-500 hover:bg-gray-50 hover:text-[#111111] transition-colors"
        title="Copy link"
      >
