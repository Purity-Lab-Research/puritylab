    ...
    <div className="mt-12 border-t border-gray-200 pt-10">
      <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
        ...
        <button
          ...
          className="rounded-lg bg-[#111111] px-4 py-2 text-sm font-semibold text-white hover:bg-[#10B981] transition-colors"
        >
          Write a Review
        </button>
      </div>
        ...
        <form onSubmit={handleSubmit} className="mb-8 rounded-xl border border-gray-200 bg-gray-50 p-5 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#10B981] focus:outline-none focus:ring-1 focus:ring-[#10B981]"
              placeholder="John D."
            />
          </div>
          <div>
